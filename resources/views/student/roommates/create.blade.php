...
@section('content')
    <div class="container-lg py-5">
        ...
        {{-- Header Section --}}
        <x-page-header title="Create Roommate Post" subtitle="Share your apartment details and find the perfect roommate"
            icon="bi bi-plus-circle" :breadcrumb="[
                    ...
                    <form action="{{ route('student.roommates.store') }}" method="POST" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title"
                                ...
                                placeholder="e.g., Looking for a clean and quiet roommate" value="{{ old('title') }}"
                                required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted small mb-2">Add preferences for your potential roommate (e.g.,
                                "Non-smoker", "Quiet hours after 10 PM", "Cleanliness level").</p>
                                    ...
                                    @foreach(old('preferences') as $index => $pref)
                                        <div class="preference-item card mb-3 bg-light border-0">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-2">
                                                    <input type="text" name="preferences[{{ $index }}][name]"
                                                        class="form-control form-control-sm"
                                                        placeholder="Preference Name (e.g. Non-smoker)" value="{{ $pref['name'] }}"
                                                        required>
                                                </div>
                                                <div>
                                                    <input type="text" name="preferences[{{ $index }}][description]"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="max_roommates" name="max_roommates"
                                class="form-control form-control-lg rounded-3 @error('max_roommates') is-invalid @enderror"
                                placeholder="How many roommates are you looking for?" value="{{ old('max_roommates') }}"
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-end">
                            <a href="{{ route('student.roommates.index') }}"
                                class="btn btn-outline-secondary px-4 fw-semibold rounded-3 py-2">
